 ...
 * @note     Generated by SVDConv V3.2.66 on Friday, 15.12.2017 22:16:35
 *           from File 'STM32L0x3.svd',
 *           last modified on Tuesday, 26.09.2017 08:52:54
 */
...
/* =========================================  STM32L0x3 Specific Interrupt Numbers  ========================================== */
  ...
  TIM6_DAC_IRQn             =  17,              /*!< 17 TIM6 global interrupt and DAC                                          */
  ...
  AES_RNG_LPUART1_IRQn      =  29,              /*!< 29 AES global interrupt RNG global interrupt and LPUART1 global
                                                     interrupt through                                                         */
  LCD_IRQn                  =  30,              /*!< 30 LCD global interrupt                                                   */
  USB_IRQn                  =  31               /*!< 31 USB event interrupt through EXTI18                                     */
} IRQn_Type;
...
#include "system_STM32L0x3.h"                   /*!< STM32L0x3 System                                                          */
...
typedef struct {                                /*!< (@ 0x40024000) TSC Structure                                              */
  ...
  __IM  uint32_t  IOG7CR;                       /*!< (@ 0x0000004C) I/O group x counter register                               */
  __IM  uint32_t  IOG8CR;                       /*!< (@ 0x00000050) I/O group x counter register                               */
} TSC_Type;                                     /*!< Size = 84 (0x54)                                                          */
...
/**
  * @brief Universal serial bus full-speed device  interface (USB_FS)
  */

typedef struct {                                /*!< (@ 0x40005C00) USB_FS Structure                                           */
  __IOM uint32_t  EP0R;                         /*!< (@ 0x00000000) endpoint register                                          */
  __IOM uint32_t  EP1R;                         /*!< (@ 0x00000004) endpoint register                                          */
  __IOM uint32_t  EP2R;                         /*!< (@ 0x00000008) endpoint register                                          */
  __IOM uint32_t  EP3R;                         /*!< (@ 0x0000000C) endpoint register                                          */
  __IOM uint32_t  EP4R;                         /*!< (@ 0x00000010) endpoint register                                          */
  __IOM uint32_t  EP5R;                         /*!< (@ 0x00000014) endpoint register                                          */
  __IOM uint32_t  EP6R;                         /*!< (@ 0x00000018) endpoint register                                          */
  __IOM uint32_t  EP7R;                         /*!< (@ 0x0000001C) endpoint register                                          */
...
typedef struct {                                /*!< (@ 0x40021000) RCC Structure                                              */
  ...
  __IOM uint32_t  CRRCR;                        /*!< (@ 0x00000008) Clock recovery RC register                                 */
...
/**
  * @brief System configuration controller and  Comparator (SYSCFG_COMP)
  */
...
typedef struct {                                /*!< (@ 0x40010000) SYSCFG_COMP Structure                                      */
  ...
  __IOM uint32_t  COMP1_CSR;                    /*!< (@ 0x00000018) Comparator 1 control and status register                   */
  __IOM uint32_t  COMP2_CSR;                    /*!< (@ 0x0000001C) Comparator 2 control and status register                   */
...
/**
  * @brief Universal synchronous asynchronous receiver  transmitter (LPUSART1)
  */

typedef struct {                                /*!< (@ 0x40004800) LPUSART1 Structure                                         */
  __IOM uint32_t  CR1;                          /*!< (@ 0x00000000) Control register 1                                         */
  __IOM uint32_t  CR2;                          /*!< (@ 0x00000004) Control register 2                                         */
  __IOM uint32_t  CR3;                          /*!< (@ 0x00000008) Control register 3                                         */
  __IOM uint32_t  BRR;                          /*!< (@ 0x0000000C) Baud rate register                                         */
...
/**
  * @brief Universal serial bus full-speed device  interface (USB_SRAM)
  */

typedef struct {                                /*!< (@ 0x40006000) USB_SRAM Structure                                         */
...
typedef struct {                                /*!< (@ 0x40002400) LCD Structure                                              */
  __IOM uint32_t  CR;                           /*!< (@ 0x00000000) control register                                           */
  __IOM uint32_t  FCR;                          /*!< (@ 0x00000004) frame control register                                     */
  __IOM uint32_t  SR;                           /*!< (@ 0x00000008) status register                                            */
  __OM  uint32_t  CLR;                          /*!< (@ 0x0000000C) clear register                                             */
  __IM  uint32_t  RESERVED;
  __IOM uint32_t  RAM_COM0;                     /*!< (@ 0x00000014) display memory                                             */
  __IM  uint32_t  RESERVED1;
  __IOM uint32_t  RAM_COM1;                     /*!< (@ 0x0000001C) display memory                                             */
  __IM  uint32_t  RESERVED2;
  __IOM uint32_t  RAM_COM2;                     /*!< (@ 0x00000024) display memory                                             */
  __IM  uint32_t  RESERVED3;
  __IOM uint32_t  RAM_COM3;                     /*!< (@ 0x0000002C) display memory                                             */
  __IM  uint32_t  RESERVED4;
  __IOM uint32_t  RAM_COM4;                     /*!< (@ 0x00000034) display memory                                             */
  __IM  uint32_t  RESERVED5;
  __IOM uint32_t  RAM_COM5;                     /*!< (@ 0x0000003C) display memory                                             */
  __IM  uint32_t  RESERVED6;
  __IOM uint32_t  RAM_COM6;                     /*!< (@ 0x00000044) display memory                                             */
  __IM  uint32_t  RESERVED7;
  __IOM uint32_t  RAM_COM7;                     /*!< (@ 0x0000004C) display memory                                             */
} LCD_Type;                                     /*!< Size = 80 (0x50)                                                          */
...
#define USB_FS_BASE                 0x40005C00UL
...
#define LPUSART1_BASE               0x40004800UL
...
#define USB_FS                      ((USB_FS_Type*)            USB_FS_BASE)
...
#define LPUSART1                    ((LPUSART1_Type*)          LPUSART1_BASE)
#define NVIC                        ((NVIC_Type*)              NVIC_BASE)
#define USB_SRAM                    ((USB_SRAM_Type*)          USB_SRAM_BASE)
